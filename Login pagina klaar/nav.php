...
<head>
    ...
    <title>nu.nl</title>
    <link rel='stylesheet' href="../nav/Login/nav1.css">
    <script src="../nav/Login/navbar.js" defer></script>
</head>
    ...
    <nav class="navbar">
        ...
        <ul class="main-menu">
            ...
            <li class="nav_itemitem_default3">
                <a href="/nu.nl/catagorie/catagorie.php?catagorie=entertainment" title="Media en Cultuur"
                    class="maatschapij">
                    Media en Cultuur
                </a>
            </li>
    ...
    <div id="myDIV" class="dropdown-menu navigation" style="display: none;">
        <ul class="site_overview">
            ...
            <li class="nav_itemitem_nuuit">
                <a class="maatschapij" href="/nu.nl/catagorie/catagorie.php?catagorie=entertainment">Media en
                    Cultuur</a>
                <ul class="nav_submenu">
                    <li class="nav_subitem">
